...
public class Data
{
	...
	Data() {
		...
		help[0][0] ="SYNTAX :\n\n" +
								...
								"down\n     tells Logo to put his pencil down so that he can draw.\n" +
								"end\n     signals the end of a procedure\n" +
								"go [exp]\n     makes Logo walk forward [exp] steps.\n" +
								...
								"left [exp]\n     makes Logo turn left [exp] degrees. If [exp] is 360, Logo turns all the way around. \n    left can be abbreviated as \"lt\".\n" +
								"newvar [var] = [exp]\n     creates a new variable with the name [var] and the value [exp].\n" +
								"procedure [procedurename]\n     signals the start of a new procedure\n" +
								"repeat [times], [name],	 [var]=[exp], ...\n     calls the procedure [name] [times] times. The number of the round will be available in\n     the procedure [name] as a variable called \"loop\".\n     [var]=[exp] works the same as for the goto command above.\n" +
								"right [exp]\n     makes Logo turn right [exp] degrees. If [exp] is 360 Logo will turn all the way around.\n" +
								"     right can be abbreviated as \"rt \".\n" +
								"up\n     tells Logo to pick his pencil up so that he can walk without drawing.\n" +
								"[var] = [exp]\n     associates the value of [exp] to the variable [var]\n" +
								
								"\nGeneral information:\n" +
								"\"/\" is used for comments = text that Logo does not read\n" +
								"\".\" for decimals\n\n" +
								"[exp] can be any arithmetic expression. \nThe number 50 is a simple arithmetic expression,\n" +
								"but you can build up more complicated expressions using `+', '-', '*' for multiplcation, and '/' for division.\n" +
								"You can use variables in the expressions as well as numbers.";
